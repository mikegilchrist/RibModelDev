...
mut.file <- "nse2000.logmu.csv"
sel.file <- "nse2000.omega.csv"
...
setRestartSettings(mcmc, "restartFile.rst", 1000, TRUE)
...
pdf("NSE2000goodCSP.pdf", width = 11, height = 12)
mixture <- 1
