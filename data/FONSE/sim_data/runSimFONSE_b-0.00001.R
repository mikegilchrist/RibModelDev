...
genome.file <- "simulatedFONSE_phiScaled10000_b-0.00001.fasta"
phi.file <- "simFONSE_scaled1000.phi.csv"
mut.file <- "S.cer.mut.ref.csv"
sel.file <- "deltaomega_b-0.00001.csv"

run.name <- "simulatedFONSE_b-0.00001_phiScaled10000"
